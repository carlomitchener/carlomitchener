const mark = document.querySelector<HTMLAnchorElement>(".mark[data-fly]");
...
if (mark) {
  ...
  document.addEventListener("click", (event) => {
    ...
    const target = event.target instanceof Element ? event.target.closest(".mark[data-fly]") : null;
