...
- [spin-harmonics](spin-harmonics/) - the spin spectrum of a design is one fixed linear function of its pair census, so some designs are homometric and no spin reading one level of refinement can tell them apart.
