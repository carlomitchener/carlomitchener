...
- `tectonic paper.tex` rebuilds it; `python3 scripts/verify.py` re-runs all nine checks in about nine seconds (`--deep` extends the two largest domains, about twelve seconds); `python3 scripts/figure.py` redraws the figures.
