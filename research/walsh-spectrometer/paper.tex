...
\end{array}
\]
where $K_j$ is the Krawtchouk polynomial $K_j(w) = \sum_{|S|=j} (-1)^{x \cdot S}$, $|x| = w$, in the normalisation of \cite[Ch.~5]{macwilliams}. The map $(m_0,m_1,m_2,m_3) \mapsto (\Sigma_0,\Sigma_1,\Sigma_2,\Sigma_3)$ is invertible.
\end{lemma}
...
B\bigl(3h{+}1{-}k{-}a{-}i(2h{+}2){-}2jh\bigr).
\label{eq:finite}
\end{equation}
...
\]
Now read the three vectors in the Krawtchouk basis of \cref{lem:kraw}, whose rows are $K_0 = (1,1,1,1)$, $K_1 = (3,1,-1,-3)$, $K_2 = (3,-1,-1,3)$, $K_3 = (1,-1,1,-1)$:
\[
\begin{aligned}
A &= 6K_0 - 3s\,K_3, \\
B &= 4K_1 - 2s\,K_2, \\
