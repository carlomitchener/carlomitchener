...
\date{First published 2026-08-31, revised 2026-09-08}
...
\begin{scope}[shift={(0.0,0)}]
  \foreach \i in {0,2,4} \foreach \j in {0,2,4} {\fill[bluedark] (\i,\j) rectangle ++(1,1);}
...
\begin{scope}[shift={(6.2,0)}]
  \foreach \i in {0,...,4} \foreach \j in {0,2,4} {\fill[bluedark] (\i,\j) rectangle ++(1,1);}
  \fill[white,opacity=0.55] (3,0) rectangle (5,5);
  \fill[white,opacity=0.55] (0,3) rectangle (3,5);
  \draw[step=1,gray!40] (0,0) grid (5,5);
  \draw[black!65,thick] (0,0) rectangle (3,3);
...
\begin{scope}[shift={(12.4,0)}]
  \foreach \i in {0,...,4} \foreach \j in {0,2,4} {\fill[bluedark] (\i,\j) rectangle ++(1,1);}
  \foreach \i in {0,2,4} \foreach \j in {1,3} {\fill[bluedark] (\i,\j) rectangle ++(1,1);}
  \fill[white,opacity=0.55] (3,0) rectangle (5,5);
  \fill[white,opacity=0.55] (0,3) rectangle (3,5);
  \draw[step=1,gray!40] (0,0) grid (5,5);
  \draw[black!65,thick] (0,0) rectangle (3,3);
...
\begin{scope}[shift={(18.6,0)}]
  \foreach \i in {0,2,4} \foreach \j in {0,2,4} {\fill[indigodark] (\i,\j) rectangle ++(1,1);}
  \foreach \i in {1,3} \foreach \j in {1,3} {\fill[indigodark] (\i,\j) rectangle ++(1,1);}
  \fill[white,opacity=0.55] (3,0) rectangle (5,5);
  \fill[white,opacity=0.55] (0,3) rectangle (3,5);
  \draw[step=1,gray!40] (0,0) grid (5,5);
  \draw[black!65,thick] (0,0) rectangle (3,3);
...
\begin{scope}[shift={(24.8,0)}]
  \foreach \i in {0,...,4} \foreach \j in {0,2,4} {\fill[indigodark] (\i,\j) rectangle ++(1,1);}
  \foreach \i in {1,3} \foreach \j in {1,3} {\fill[indigodark] (\i,\j) rectangle ++(1,1);}
  \fill[white,opacity=0.55] (3,0) rectangle (5,5);
  \fill[white,opacity=0.55] (0,3) rectangle (3,5);
  \draw[step=1,gray!40] (0,0) grid (5,5);
...
\begin{scope}[shift={(31.0,0)}]
  \foreach \i in {0,...,4} \foreach \j in {0,...,4} {\fill[indigodark] (\i,\j) rectangle ++(1,1);}
  \fill[white,opacity=0.55] (3,0) rectangle (5,5);
  \fill[white,opacity=0.55] (0,3) rectangle (3,5);
  \draw[step=1,gray!40] (0,0) grid (5,5);
  \draw[black!65,thick] (0,0) rectangle (3,3);
...
Substitute $1-k$ for $k$. Then $k^{D-w}(k-1)^{w}$ becomes $(1-k)^{D-w}(-k)^{w}$, which is $(-1)^{D}k^{w}(k-1)^{D-w}$. Hence
\[
