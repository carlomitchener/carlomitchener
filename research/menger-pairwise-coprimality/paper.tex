...
For the joint statement, let $\mathcal S=\{s:\text{weight}(s)\ge2\}$, the set of $s$ with at most one $s_i=0$. By Fourier inversion,
\[
...
\bibitem{oeisA065473}
OEIS Foundation Inc., \emph{Sequence A065473: decimal expansion of the strongly carefree constant $\prod_p\bigl(1-(3p-2)/p^3\bigr)$}, The On-Line Encyclopedia of Integer Sequences. \href{https://oeis.org/A065473}{https://oeis.org/A065473}
